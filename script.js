...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===== WEATHER APP INFO FUNCTION =====
    
    window.showWeatherAppInfo = function() {
        const info = `
            ...
            Note: To use with real API data, you'll need to get a free API key from OpenWeatherMap and replace 'YOUR_API_KEY' in the code.
        `;
